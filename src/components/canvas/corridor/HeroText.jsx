...
const HeroText = ({ position = [0, 0.3, 0] }) => {
  ...
  const letters = useMemo(
    () => [
      ...
      { char: "N", baseX: -0.43, splitDir: -0.6, delay: 0 },
      { char: "K", baseX: 0.23, splitDir: 0.6, delay: 0 },
      { char: "I", baseX: 0.75, splitDir: 1.3, delay: 0 },
      { char: "T", baseX: 1.25, splitDir: 1.8, delay: 0 },
    ],
    [],
  );
  ...
  const taglineWords = useMemo(
    () => [
      { text: "<", baseX: -0.95, splitDir: -1.5, delay: 0 },
      { text: "fullstack", baseX: -0.35, splitDir: -0.8, delay: 0 },
      { text: "developer", baseX: 0.4, splitDir: 0.8, delay: 0 },
      { text: "/>", baseX: 0.95, splitDir: 1.5, delay: 0 },
    ],
    [],
  ...
  useFrame((state, delta) => {
    ...
    splitAmount.current = THREE.MathUtils.lerp(
      splitAmount.current,
      targetSplit.current,
      0.08,
    );
    ...
    letterRefs.current.forEach((ref, i) => {
      if (ref) {
        ...
        ref.rotation.z =
          Math.sin(time * 0.5 + i) * 0.02 * (1 + splitAmount.current);
      }
    });
